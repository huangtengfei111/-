...
![RDB和AOF的介绍](E:\U盘\视频\24_怎么保证redis挂掉之后再重启数据可以进行恢复？\03_图解分析redis的RDB和AOF两种持久化机制的工作原理\RDB和AOF的介绍.png)

![AOF rewrite原理剖析](E:\U盘\视频\24_怎么保证redis挂掉之后再重启数据可以进行恢复？\03_图解分析redis的RDB和AOF两种持久化机制的工作原理\AOF rewrite原理剖析.png)
